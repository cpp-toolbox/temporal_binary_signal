...
bool TemporalBinarySignal::is_on() { return current_state == State::on; }
bool TemporalBinarySignal::is_off() { return current_state == State::off; }
bool TemporalBinarySignal::is_just_on() { return current_state == State::just_on; }
bool TemporalBinarySignal::is_just_off() { return current_state == State::just_off; }
